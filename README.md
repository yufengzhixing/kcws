...
4. 安装好tensorflow,切换到kcws代码目录，运行:
  > python kcws/train/train_cws_lstm.py --word2vec_path char_vec.txt --train_data_path 绝对路径到/train.enc --test_data_path test.enc --max_sentence_len 80 --learning_rate 0.001
