...
if __name__ == '__main__':
    ...
    parser.add_argument("--frozen_model_filename", default="/home/di/pycharmProjects/segment/kcws-master/kcws/models/ner_model_c.pbtxt", type=str, help="Frozen model file to import")
    ...
    while True:
        input_string = raw_input('输入语句： > ').strip()
        # 退出
